...
export interface UseTransactionSubmissionProps {
  ...
  setTransaction: (data: BaseTransaction) => void;
  mutateTransaction: (data?: TransactionFetcherData, options?: { revalidate?: boolean }) => Promise<TransactionFetcherData | undefined>;
