...
## งาน
ดูข้อมูลรายการนี้ แล้วเลือกบัญชีที่เหมาะสมที่สุดจากรายการด้านล่าง
...
- **เลือกที่ใกล้เคียงที่สุด** - ถ้าไม่มีตรง 100% ก็เลือกที่เหมาะสมที่สุด
- **ห้ามบอกว่าไม่พบ** - มีบัญชีให้เลือกแล้ว ต้องเลือกอันใดอันหนึ่ง
