...
3. **ดึงข้อมูลการเงิน**
   ...
   - **หัก ณ ที่จ่าย (WHT)** - สำคัญ! ดูข้อมูลเหล่านี้:
     - whtAmount: "จำนวนเงินที่ถูกหัก ณ ที่จ่าย", "ภาษีหัก ณ ที่จ่าย", "หัก ณ ที่จ่าย"
     - whtRate: คำนวณจาก (whtAmount / amount) * 100 → ปัดเป็น 1%, 2%, 3%, หรือ 5%
     - whtType: ดูจากประเภทค่าใช้จ่าย (ค่าบริการ=3%, ค่าขนส่ง=1%, ค่าเช่า=5%)
   - ยอดสุทธิที่ต้องจ่าย/รับจริง (netAmount) = ยอดรวม VAT - หัก ณ ที่จ่าย
...
- **⚠️ WHT อาจปรากฏในเอกสารทุกประเภท** - ไม่ใช่แค่ใบ 50 ทวิ! ถ้าเห็น "หัก ณ ที่จ่าย" หรือ "ภาษีหัก" ในเอกสารใดๆ ให้ดึงข้อมูลใส่ wht object
